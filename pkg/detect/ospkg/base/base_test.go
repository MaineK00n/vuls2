...
func Test_convertVCQueryPackage(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, err := base.ConvertVCQueryPackage(tt.args.family, tt.args.p)
...
func Test_rename(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := base.Rename(tt.args.family, tt.args.name); got != tt.want {
...
func Test_isKernelPackage(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := base.IsKernelPackage(tt.args.family, tt.args.name); got != tt.want {
